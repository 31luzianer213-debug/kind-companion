...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("rounded-lg border bg-card text-card-foreground shadow-[0_1px_2px_color-mix(in_oklch,var(--foreground)_5%,transparent),0_16px_36px_-28px_color-mix(in_oklch,var(--foreground)_20%,transparent)] transition-[border-color,box-shadow] duration-200", className)} {...props} />
  ),
);
